...
const ALL_PRODUCTS: Product[] = [
  ...
  { id:'9',  name:'Gold Chain Necklace',     brand:'BrinmBT Studio',   slug:'gold-chain-necklace',     category:'accessories', description:'18k gold-plated necklace.',        price:79,  badge:null,   images:[{url:'',alt:''}], variants:[{size:'One Size',stock:20}],                                                     rating:4.9, reviewCount:91,  isFeatured:false, isNew:false, createdAt:'2026-01-24' },
