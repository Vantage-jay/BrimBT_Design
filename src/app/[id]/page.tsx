...
/* ============================================================
   BrimBT Design — Product Detail Page
...
const ALL_PRODUCTS: Product[] = [
  ...
  { id:'2', name:'Cloud Runner Sneakers', brand:'BrimBT Footwear', slug:'cloud-runner-sneakers', category:'footwear', description:'Ultra-light performance sneakers engineered with our proprietary cloud sole technology. The breathable mesh upper keeps your feet cool while the responsive foam midsole absorbs impact with every step.',          price:142, originalPrice:180, badge:'sale', images:[{url:'',alt:'Side View'},{url:'',alt:'Top View'},{url:'',alt:'Sole'}], variants:[{size:'38',stock:5},{size:'39',stock:7},{size:'40',stock:4},{size:'41',stock:0}], rating:4.8, reviewCount:89,  isFeatured:true,  isNew:false, createdAt:'2026-01-05' },
  { id:'3', name:'Linen Wide Leg Set',    brand:'BrimBT Studio',   slug:'linen-wide-leg-set',    category:'clothing', description:'Breathable linen co-ord set featuring wide leg trousers and a matching relaxed crop top. Crafted from 100% Belgian linen, this set is designed for effortless warm-weather dressing.',                             price:224, badge:null,   images:[{url:'',alt:'Full Look'},{url:'',alt:'Top'},{url:'',alt:'Trousers'}],           variants:[{size:'S',stock:6},{size:'M',stock:9},{size:'L',stock:5},{size:'XL',stock:3}],  rating:4.7, reviewCount:67,  isFeatured:true,  isNew:false, createdAt:'2026-01-10' },
  { id:'4', name:'Sculptured Heel Mule',  brand:'BrimBT Footwear', slug:'sculptured-heel-mule',  category:'footwear', description:'Architectural heel mule crafted from premium full-grain leather. The sculptured 80mm block heel provides both height and stability, while the open-toe silhouette keeps the look fresh and modern.',              price:165, badge:'hot',  images:[{url:'',alt:'Side View'},{url:'',alt:'Front'},{url:'',alt:'Heel Detail'}],        variants:[{size:'36',stock:3},{size:'37',stock:5},{size:'38',stock:4},{size:'39',stock:6}], rating:4.9, reviewCount:102, isFeatured:true,  isNew:false, createdAt:'2026-01-12' },
  { id:'5', name:'Ribbed Bodysuit',       brand:'BrimBT Studio',   slug:'ribbed-bodysuit',       category:'clothing', description:'Seamless ribbed bodysuit with a high scoop neck and snap closure at the gusset. Made from a soft cotton-modal blend that moves with you all day.',                                                                 price:89,  badge:'new',  images:[{url:'',alt:'Front'}],                                                           variants:[{size:'XS',stock:6},{size:'S',stock:10},{size:'M',stock:8},{size:'L',stock:4}],  rating:4.6, reviewCount:58,  isFeatured:false, isNew:true,  createdAt:'2026-01-15' },
  { id:'6', name:'Platform Chelsea Boot', brand:'BrimBT Footwear', slug:'platform-chelsea-boot', category:'footwear', description:'Chunky platform Chelsea boot in smooth vegan leather. Pull-on style with elasticated side panels and a 40mm platform sole.',                                                                                    price:198, badge:null,   images:[{url:'',alt:'Side'}],                                                            variants:[{size:'37',stock:4},{size:'38',stock:6},{size:'39',stock:5},{size:'40',stock:3}], rating:4.7, reviewCount:43,  isFeatured:false, isNew:false, createdAt:'2026-01-18' },
  { id:'7', name:'Oversized Blazer',      brand:'BrimBT Studio',   slug:'oversized-blazer',      category:'clothing', description:'Structured oversized blazer in a premium wool blend. Single-button closure, notched lapels, and two welt pockets.',                                                                                            price:265, badge:null,   images:[{url:'',alt:'Front'}],                                                           variants:[{size:'S',stock:3},{size:'M',stock:5},{size:'L',stock:4},{size:'XL',stock:2}],  rating:4.8, reviewCount:76,  isFeatured:false, isNew:false, createdAt:'2026-01-20' },
  { id:'8', name:'Woven Tote Bag',        brand:'BrimBT Studio',   slug:'woven-tote-bag',        category:'bags',     description:'Handwoven structured tote in natural raffia with leather handles. Spacious interior with a zip inner pocket.',                                                                                                price:134, badge:'new',  images:[{url:'',alt:'Front'}],                                                           variants:[{size:'One Size',stock:12}],                                                     rating:4.5, reviewCount:34,  isFeatured:false, isNew:true,  createdAt:'2026-01-22' },
]
